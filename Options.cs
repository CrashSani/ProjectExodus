...
namespace PixelCrushers.DialogueSystem.MenuSystem
{
    ...
    public class Options : MonoBehaviour
    {
        ...
        public UnityEngine.UI.Slider voiceVolumeSlider;//Added for voice control
        public string voiceVolumeMixerParameter = "voiceVol";//Added for voice control
        public string voiceVolumePrefsKey = "options.voiceVol";//Added for voice control
        public AudioClip soundClip;//Added whenever slider moves 
        public AudioSource exampleMusicAudioSource;//Added for Music
        ...
        public virtual void RefreshMenuElements()
        {
            ...
            RefreshVoiceVolumeSlider();//added for voice
        }
        ...
        public virtual void SetMusicLevel(float musicLevel)//added this part
        {
            ...
            PlayerPrefs.SetFloat(musicVolumePrefsKey, musicLevel);//Edited for Music Slider
            //exampleMusicAudioSource.Play();///HERE!
        ...
        protected virtual void RefreshVoiceVolumeSlider()//added for voice slider//Refreshes voicevolume slider
        {
        ...
        public virtual void SetVoiceLevel(float voiceLevel)//added for voice valuess
        {
            if (!m_started) return;
            if (mainMixer != null)
            {
